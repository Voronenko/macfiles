...
export PATH=${HOME}/dotfiles/bin:$HOME/.rbenv/bin:$HOME/.jenv/bin:$HOME/.local/bin:/usr/local/bin:$HOME/config/composer/vendor/bin:$PATH:${KREW_ROOT:-$HOME/.krew}/bin:${HOME}/dotfiles/bin/wrappers/
