...
files="bashrc gitconfig oh-my-zsh nanorc ruby-version selected_editor vimrc zshrc direnvrc terraform-version"    # list of files/folders to symlink in homedir
